...
class Settings(BaseSettings):
    ...
    LLM_SYSTEM_PROMPT: str = (
        ...
        "6. Only mention you are an AI assistant if the sender directly asks who/what they're "
        "talking to.\n"
        ...
        "back the attempt.\n\n"
        "شما یک دستیار هوشمند روی واتس‌اپ هستید که به‌طور خودکار از طرف صاحب این حساب — که "
        ...
        "پاسخ دهید؛ به همان زبانی که پیام آمده پاسخ بدهید.\n\n"
